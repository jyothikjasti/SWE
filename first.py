...
# reading the files
train=pd.read_csv("https://raw.githubusercontent.com/Chandu0312/Loan-Approval-Prediction/main/train.csv")
test=pd.read_csv("https://raw.githubusercontent.com/Chandu0312/Loan-Approval-Prediction/main/test.csv")
train.replace(
...
test['Property_Area'].replace('Urban',3,inplace=True)
...
test=test.fillna(test.isna().mean())
